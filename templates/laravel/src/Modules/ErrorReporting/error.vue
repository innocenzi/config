...
<template>
	<div class="h-dynamic bg-jetfly-cream-200 flex flex-col pb-12 pt-16">
		<main class="mx-auto flex w-full max-w-7xl grow flex-col justify-center px-4 sm:px-6 lg:px-8">
			<div class="pb-16 pt-10">
				<div class="text-center">
					<p class="text-jetfly-taupe-500 text-lg font-semibold uppercase tracking-wide" v-text="status" />
					<h1 v-if="title" class="text-jetfly-black mt-2 text-4xl font-extrabold tracking-tight sm:text-5xl" v-text="title" />
					<p v-if="description" class="text-jetfly-grey-500 mt-2 text-lg" v-text="description" />
